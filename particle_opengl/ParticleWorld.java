...
/**
 * Defines a particle world/scene
 */
public class ParticleWorld implements Runnable {
...
*/
   ...
   public void run() {
      ...
      createGLWindow("Particles", WIN_WIDTH, WIN_HEIGHT, m_nBits);
    ...
    */
   private synchronized void createGLWindow(String title, int width, int height, int bit) {
    ...
    * 
    */
   private synchronized void createGLEnabledFrame(int width, int height, int bit) {
    ...
    *          a display.
    */
   private synchronized GraphicsDevice getDefaultScreen() throws HeadlessException {
...
*/
    ...
    */
   private synchronized void setWindowedMode(GraphicsDevice defaultScreen) {
    ...
    * @param defaultScreen The default screen where the window resides.
    */
   private synchronized void setFullScreenMode(GraphicsDevice defaultScreen) {
    ...
    */
   private synchronized void setWindowUndecorated(boolean decorated) {
    ...
    */
   protected synchronized void toggleFilter() {
