...
/**
 * This class provides key pressed/released events handling
 */
public class KeyHandler implements KeyListener {
    ...
    */
   public KeyHandler(ParticleWorld parent) {
      m_oParent = parent;
   }
   ...
   public void keyPressed(KeyEvent e) {
      ...
      switch (keyCode) {
         ...
         case KeyEvent.VK_H :
            ...
            break;
         case KeyEvent.VK_F1 :
            // The F1 key speeds up particles (i.e. The slow-down factor
            // decreases.)
            m_oParent.changeSlowDown(false);
            break;
         case KeyEvent.VK_F2 :
            // The F2 key slows down particles (i.e. The slow-down factor
            // increases.)
